 ...
 * ```
 */
export function createPaginationSchema<T extends readonly [string, ...Array<string>]>(
	sortableFields: T,
 ...
 * ```
 */
export function createCursorPaginationSchema<T extends readonly [string, ...Array<string>]>(
	sortableFields: T,
	defaultSort: { id: T[number]; desc: boolean } = {
		id: sortableFields[0],
		desc: false
