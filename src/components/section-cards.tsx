	...
	return (
		<div className='grid @5xl/main:grid-cols-4 @xl/main:grid-cols-2 grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-linear-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card *:data-[slot=card]:shadow-xs lg:px-6 dark:*:data-[slot=card]:bg-card'>
			<Card className='@container/card'>
				...
				<CardFooter className='flex-col items-start gap-1.5 text-sm'>
					<div className='line-clamp-1 flex gap-2 font-medium'>
						Trending up this month <Icons.arrowUp className='size-4' />
					</div>
			...
			<Card className='@container/card'>
				...
				<CardFooter className='flex-col items-start gap-1.5 text-sm'>
					<div className='line-clamp-1 flex gap-2 font-medium'>
						Down 20% this period <Icons.arrowDown className='size-4' />
					</div>
			...
			<Card className='@container/card'>
				...
				<CardFooter className='flex-col items-start gap-1.5 text-sm'>
					<div className='line-clamp-1 flex gap-2 font-medium'>
						Strong user retention <Icons.arrowUp className='size-4' />
					</div>
			...
			<Card className='@container/card'>
				...
				<CardFooter className='flex-col items-start gap-1.5 text-sm'>
					<div className='line-clamp-1 flex gap-2 font-medium'>
						Steady performance increase <Icons.arrowUp className='size-4' />
					</div>
